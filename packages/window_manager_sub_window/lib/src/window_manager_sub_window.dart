...
import 'package:window_manager_sub_window/src/resize_edge.dart';
import 'package:window_manager_sub_window/src/title_bar_style.dart';
import 'package:window_manager_sub_window/src/utils/calc_window_position.dart';
import 'package:window_manager_sub_window/src/window_listener.dart';
import 'package:window_manager_sub_window/src/window_options.dart';
...
class WindowManagerSubWindow {
  WindowManagerSubWindow._() {
    _channel.setMethodCallHandler(_methodCallHandler);
  }

  /// The shared instance of [WindowManagerSubWindow].
  static final WindowManagerSubWindow instance = WindowManagerSubWindow._();

  final MethodChannel _channel =
      const MethodChannel('window_manager_sub_window');
...
final windowManagerSubWindow = WindowManagerSubWindow.instance;
