...
import 'package:window_manager_sub_window/src/widgets/drag_to_move_area.dart';
import 'package:window_manager_sub_window/src/widgets/window_caption_button.dart';
...
///       title: Text('window_manager_sub_window_example'),
///     ),
    ...
    return DecoratedBox(
      ...
      child: Row(
        children: [
          ...
          FutureBuilder<bool>(
            future: windowManagerSubWindow.isMaximized(),
