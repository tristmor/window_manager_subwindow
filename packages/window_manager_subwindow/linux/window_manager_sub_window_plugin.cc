...
#define WINDOW_MANAGER_PLUGIN(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),                                       \
                              window_manager_sub_window_plugin_get_type(), \
                              WindowManagerSubWindowPlugin))

struct _WindowManagerSubWindowPlugin {
...
G_DEFINE_TYPE(WindowManagerSubWindowPlugin,
              window_manager_sub_window_plugin,
              g_object_get_type())

// Gets the window being controlled.
GtkWindow* get_window(WindowManagerSubWindowPlugin* self) {
...
GdkWindow* get_gdk_window(WindowManagerSubWindowPlugin* self) {
  return gtk_widget_get_window(GTK_WIDGET(get_window(self)));
}

static FlMethodResponse* set_as_frameless(WindowManagerSubWindowPlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* destroy(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* close(WindowManagerSubWindowPlugin* self) {
  gtk_window_close(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_prevent_close(WindowManagerSubWindowPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(self->_is_prevent_close);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_prevent_close(WindowManagerSubWindowPlugin* self,
                                           FlValue* args) {
...
static FlMethodResponse* focus(WindowManagerSubWindowPlugin* self) {
  gtk_window_present(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* blur(WindowManagerSubWindowPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_focused(WindowManagerSubWindowPlugin* self) {
  bool is_focused = gtk_window_is_active(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_focused);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* show(WindowManagerSubWindowPlugin* self) {
  gtk_widget_show(GTK_WIDGET(get_window(self)));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* hide(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* is_visible(WindowManagerSubWindowPlugin* self) {
  bool is_visible = gtk_widget_is_visible(GTK_WIDGET(get_window(self)));
  g_autoptr(FlValue) result = fl_value_new_bool(is_visible);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_maximized(WindowManagerSubWindowPlugin* self) {
  bool is_maximized = gtk_window_is_maximized(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_maximized);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* maximize(WindowManagerSubWindowPlugin* self) {
  gtk_window_maximize(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* unmaximize(WindowManagerSubWindowPlugin* self) {
  gtk_window_unmaximize(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_minimized(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* minimize(WindowManagerSubWindowPlugin* self) {
  gtk_window_iconify(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_dockable(WindowManagerSubWindowPlugin* self) {
  bool is_docked = false;
  g_autoptr(FlValue) result = fl_value_new_bool(is_docked);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_docked(WindowManagerSubWindowPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_null();
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* dock(WindowManagerSubWindowPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* undock(WindowManagerSubWindowPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* restore(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* is_full_screen(WindowManagerSubWindowPlugin* self) {
  GdkWindowState state = gdk_window_get_state(get_gdk_window(self));
  g_autoptr(FlValue) result =
...
static FlMethodResponse* set_full_screen(WindowManagerSubWindowPlugin* self,
                                         FlValue* args) {
  bool is_full_screen =
...
static FlMethodResponse* set_aspect_ratio(WindowManagerSubWindowPlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* set_background_color(
    WindowManagerSubWindowPlugin* self,
    FlValue* args) {
  GdkRGBA rgba;
...
static FlMethodResponse* get_bounds(WindowManagerSubWindowPlugin* self) {
  gint x, y, width, height;
  gtk_window_get_position(get_window(self), &x, &y);
  gtk_window_get_size(get_window(self), &width, &height);
...
static FlMethodResponse* set_bounds(WindowManagerSubWindowPlugin* self,
                                    FlValue* args) {
...
static FlMethodResponse* set_minimum_size(WindowManagerSubWindowPlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* set_maximum_size(WindowManagerSubWindowPlugin* self,
                                          FlValue* args) {
  const float width = fl_value_get_float(fl_value_lookup_string(args, "width"));
  const float height =
      fl_value_get_float(fl_value_lookup_string(args, "height"));
...
static FlMethodResponse* is_resizable(WindowManagerSubWindowPlugin* self) {
  bool is_resizable = gtk_window_get_resizable(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_resizable);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_resizable(WindowManagerSubWindowPlugin* self,
                                       FlValue* args) {
  bool is_resizable =
...
static FlMethodResponse* is_minimizable(WindowManagerSubWindowPlugin* self) {
  GdkWindowState state = gdk_window_get_state(get_gdk_window(self));
...
static FlMethodResponse* set_minimizable(WindowManagerSubWindowPlugin* self,
                                         FlValue* args) {
...
static FlMethodResponse* is_maximizable(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* set_maximizable(WindowManagerSubWindowPlugin* self,
                                         FlValue* args) {
...
static FlMethodResponse* is_closable(WindowManagerSubWindowPlugin* self) {
  bool is_closable = gtk_window_get_deletable(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_closable);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_closable(WindowManagerSubWindowPlugin* self,
                                      FlValue* args) {
  bool is_closable =
...
static FlMethodResponse* is_always_on_top(WindowManagerSubWindowPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(self->_is_always_on_top);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_always_on_top(WindowManagerSubWindowPlugin* self,
                                           FlValue* args) {
  bool isAlwaysOnTop =
...
static FlMethodResponse* is_always_on_bottom(
    WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* get_title(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* set_title(WindowManagerSubWindowPlugin* self,
                                   FlValue* args) {
  const gchar* title =
...
static FlMethodResponse* set_title_bar_style(WindowManagerSubWindowPlugin* self,
                                             FlValue* args) {
...
static FlMethodResponse* get_title_bar_height(
    WindowManagerSubWindowPlugin* self,
    FlValue* args) {
...
static FlMethodResponse* is_skip_taskbar(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* set_skip_taskbar(WindowManagerSubWindowPlugin* self,
                                          FlValue* args) {
  bool isSkipTaskbar =
...
static FlMethodResponse* set_icon(WindowManagerSubWindowPlugin* self,
                                  FlValue* args) {
...
static FlMethodResponse* get_opacity(WindowManagerSubWindowPlugin* self) {
  gdouble opacity = gtk_widget_get_opacity(GTK_WIDGET(get_window(self)));
  g_autoptr(FlValue) result = fl_value_new_float(opacity);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_opacity(WindowManagerSubWindowPlugin* self,
                                     FlValue* args) {
...
static FlMethodResponse* pop_up_window_menu(
    WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* start_dragging(WindowManagerSubWindowPlugin* self) {
...
static void find_event_box(WindowManagerSubWindowPlugin* plugin,
                           GtkWidget* widget) {
  GList* children = NULL;
...
static FlMethodResponse* start_resizing(WindowManagerSubWindowPlugin* self,
                                        FlValue* args) {
...
static GdkGrabStatus gdk_grab_keyboard(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* grab_keyboard(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* ungrab_keyboard(WindowManagerSubWindowPlugin* self) {
...
static FlMethodResponse* set_brightness(WindowManagerSubWindowPlugin* self,
                                        FlValue* args) {
...
static void window_manager_sub_window_plugin_handle_method_call(
    WindowManagerSubWindowPlugin* self,
...
static void window_manager_sub_window_plugin_dispose(GObject* object) {
  WindowManagerSubWindowPlugin* self = WINDOW_MANAGER_PLUGIN(object);
  g_clear_object(&self->css_provider);
  g_free(self->title_bar_style_);
  G_OBJECT_CLASS(window_manager_sub_window_plugin_parent_class)
      ->dispose(object);
}

static void window_manager_sub_window_plugin_class_init(
    WindowManagerSubWindowPluginClass* klass) {
  G_OBJECT_CLASS(klass)->dispose = window_manager_sub_window_plugin_dispose;
}

static void window_manager_sub_window_plugin_init(
    WindowManagerSubWindowPlugin* self) {}

static void method_call_cb(FlMethodChannel* channel,
                           FlMethodCall* method_call,
                           gpointer user_data) {
  WindowManagerSubWindowPlugin* plugin = WINDOW_MANAGER_PLUGIN(user_data);
  window_manager_sub_window_plugin_handle_method_call(plugin, method_call);
}

void _emit_event(WindowManagerSubWindowPlugin* plugin, const char* event_name) {
  g_autoptr(FlValue) result_data = fl_value_new_map();
...
gboolean on_window_close(GtkWidget* widget, GdkEvent* event, gpointer data) {
  WindowManagerSubWindowPlugin* plugin = WINDOW_MANAGER_PLUGIN(data);
...
void emit_button_release(WindowManagerSubWindowPlugin* self) {
...
void window_manager_sub_window_plugin_register_with_registrar(
    FlPluginRegistrar* registrar) {
  WindowManagerSubWindowPlugin* plugin = WINDOW_MANAGER_PLUGIN(
      g_object_new(window_manager_sub_window_plugin_get_type(), nullptr));
  ...
  plugin->channel = fl_method_channel_new(
      fl_plugin_registrar_get_messenger(registrar), "window_manager_sub_window",
