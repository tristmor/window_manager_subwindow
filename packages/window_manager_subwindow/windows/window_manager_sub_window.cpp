...
class WindowManagerSubWindow {
 public:
  WindowManagerSubWindow();

  virtual ~WindowManagerSubWindow();
  ...
  HWND GetMainWindow();
  void WindowManagerSubWindow::ForceRefresh();
  void WindowManagerSubWindow::ForceChildRefresh();
  void WindowManagerSubWindow::SetAsFrameless();
  void WindowManagerSubWindow::WaitUntilReadyToShow();
  void WindowManagerSubWindow::Destroy();
  void WindowManagerSubWindow::Close();
  bool WindowManagerSubWindow::IsPreventClose();
  void WindowManagerSubWindow::SetPreventClose(
      const flutter::EncodableMap& args);
  void WindowManagerSubWindow::Focus();
  void WindowManagerSubWindow::Blur();
  bool WindowManagerSubWindow::IsFocused();
  void WindowManagerSubWindow::Show();
  void WindowManagerSubWindow::Hide();
  bool WindowManagerSubWindow::IsVisible();
  bool WindowManagerSubWindow::IsMaximized();
  void WindowManagerSubWindow::Maximize(const flutter::EncodableMap& args);
  void WindowManagerSubWindow::Unmaximize();
  bool WindowManagerSubWindow::IsMinimized();
  void WindowManagerSubWindow::Minimize();
  void WindowManagerSubWindow::Restore();
  bool WindowManagerSubWindow::IsDockable();
  int WindowManagerSubWindow::IsDocked();
  void WindowManagerSubWindow::Dock(const flutter::EncodableMap& args);
  bool WindowManagerSubWindow::Undock();
  bool WindowManagerSubWindow::IsFullScreen();
  void WindowManagerSubWindow::SetFullScreen(const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetAspectRatio(
      const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetBackgroundColor(
      const flutter::EncodableMap& args);
  flutter::EncodableMap WindowManagerSubWindow::GetBounds(
      const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetBounds(const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetMinimumSize(
      const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetMaximumSize(
      const flutter::EncodableMap& args);
  bool WindowManagerSubWindow::IsResizable();
  void WindowManagerSubWindow::SetResizable(const flutter::EncodableMap& args);
  bool WindowManagerSubWindow::IsMinimizable();
  void WindowManagerSubWindow::SetMinimizable(
      const flutter::EncodableMap& args);
  bool WindowManagerSubWindow::IsMaximizable();
  void WindowManagerSubWindow::SetMaximizable(
      const flutter::EncodableMap& args);
  bool WindowManagerSubWindow::IsClosable();
  void WindowManagerSubWindow::SetClosable(const flutter::EncodableMap& args);
  bool WindowManagerSubWindow::IsAlwaysOnTop();
  void WindowManagerSubWindow::SetAlwaysOnTop(
      const flutter::EncodableMap& args);
  bool WindowManagerSubWindow::IsAlwaysOnBottom();
  void WindowManagerSubWindow::SetAlwaysOnBottom(
      const flutter::EncodableMap& args);
  std::string WindowManagerSubWindow::GetTitle();
  void WindowManagerSubWindow::SetTitle(const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetTitleBarStyle(
      const flutter::EncodableMap& args);
  int WindowManagerSubWindow::GetTitleBarHeight();
  bool WindowManagerSubWindow::IsSkipTaskbar();
  void WindowManagerSubWindow::SetSkipTaskbar(
      const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetProgressBar(
      const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetIcon(const flutter::EncodableMap& args);
  bool WindowManagerSubWindow::HasShadow();
  void WindowManagerSubWindow::SetHasShadow(const flutter::EncodableMap& args);
  double WindowManagerSubWindow::GetOpacity();
  void WindowManagerSubWindow::SetOpacity(const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetBrightness(const flutter::EncodableMap& args);
  void WindowManagerSubWindow::SetIgnoreMouseEvents(
      const flutter::EncodableMap& args);
  void WindowManagerSubWindow::PopUpWindowMenu(
      const flutter::EncodableMap& args);
  void WindowManagerSubWindow::StartDragging();
  void WindowManagerSubWindow::StartResizing(const flutter::EncodableMap& args);
 ...
 private:
  ...
  BOOL WindowManagerSubWindow::RegisterAccessBar(HWND hwnd, BOOL fRegister);
  void PASCAL WindowManagerSubWindow::AppBarQuerySetPos(HWND hwnd,
                                                        UINT uEdge,
                                                        LPRECT lprc,
                                                        PAPPBARDATA pabd);
  void WindowManagerSubWindow::DockAccessBar(HWND hwnd,
                                             UINT edge,
                                             UINT windowWidth);
};

WindowManagerSubWindow::WindowManagerSubWindow() {}

WindowManagerSubWindow::~WindowManagerSubWindow() {}

HWND WindowManagerSubWindow::GetMainWindow() {
...
double WindowManagerSubWindow::GetDpiForHwnd(HWND hWnd) {
...
void WindowManagerSubWindow::SetAspectRatio(const flutter::EncodableMap& args) {
  aspect_ratio_ =
...
void WindowManagerSubWindow::SetMinimumSize(const flutter::EncodableMap& args) {
  double devicePixelRatio =
      std::get<double>(args.at(flutter::EncodableValue("devicePixelRatio")));
...
void WindowManagerSubWindow::SetMaximumSize(const flutter::EncodableMap& args) {
  double devicePixelRatio =
      std::get<double>(args.at(flutter::EncodableValue("devicePixelRatio")));
  double width = std::get<double>(args.at(flutter::EncodableValue("width")));
  double height = std::get<double>(args.at(flutter::EncodableValue("height")));
...
void WindowManagerSubWindow::SetMinimizable(const flutter::EncodableMap& args) {
  HWND hWnd = GetMainWindow();
  bool isMinimizable =
...
void WindowManagerSubWindow::SetMaximizable(const flutter::EncodableMap& args) {
  HWND hWnd = GetMainWindow();
  bool isMaximizable =
...
void WindowManagerSubWindow::SetAlwaysOnTop(const flutter::EncodableMap& args) {
  bool isAlwaysOnTop =
...
void WindowManagerSubWindow::SetSkipTaskbar(const flutter::EncodableMap& args) {
  is_skip_taskbar_ =
...
void WindowManagerSubWindow::SetProgressBar(const flutter::EncodableMap& args) {
  double progress =
